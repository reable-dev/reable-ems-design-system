...
const meta: Meta<typeof DropdownMultiSelect> = {
  title: 'common/DropdownMultiSelect',
...
export const Default = (args: any) => {
  return (
    <Container>
      <DropdownMultiSelect searchEnabled="search" {...args} options={roomTypeOptions} />
    </Container>
  );
};
 ...
 */
export const DropdownMultiSelectState = (args: any) => {
  const [value, setValue] = useState('');

  const handleDropdownMultiSelectChange = (value: any) => {
    console.log('dropdownMultiSelect value>>', value);
